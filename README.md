...
<table>
  ...
  <tr>
    ...
    <td align="center"><code>5.67 / 10</code></td>
    <td align="center"><code>~120.0h</code></td>
  </tr>
</table>

<sub>🕐 Last updated: 2026-05-02T19:59:38</sub>
<!-- END:stats -->
...
<table>
  <tr>
    <td>
      <b><a href="https://github.com/hashicorp/terraform/issues/6632">Ignore changes for a single AWS Resource Tag</a></b><br/>
      <sub>📦 <code>hashicorp/terraform</code> &nbsp;&#183;&nbsp; 💥 Impact: <b>5/10</b> &nbsp;&#183;&nbsp; 🗓️ 2026-05-02</sub><br/><br/>
      <i>The proposed feature is necessary because it addresses a significant limitation in the current implementation of the ignore_changes argument in Terraform, which only allows users...</i>
    </td>
  </tr>
</table><!-- END:last -->
...
|:----:|-------|------|:------:|----------------|
| 🥇 | [terraform get: can't use variable in module source parameter?](https://github.com/hashicorp/terraform/issues/1439) | `hashicorp/terraform` | **6/10** | This feature will succeed now because it addresses a long-standing issue in Terraform's module management system, and provides users with a way to dynamically configure... |
| 🥈 | [offer to create missing bucket and lock_table for s3 backend](https://github.com/hashicorp/terraform/issues/12780) | `hashicorp/terraform` | **6/10** | Improve user experience and reduce errors by automating the creation of S3 buckets and lock tables, which is a common pain point for Terraform users... |
| 🥉 | [Ignore changes for a single AWS Resource Tag](https://github.com/hashicorp/terraform/issues/6632) | `hashicorp/terraform` | **5/10** | The proposed feature is necessary because it addresses a significant limitation in the current implementation of the ignore_changes argument in Terraform, which only allows users... |<!-- END:hall-of-fame -->
...
<!-- SECTION:footer -->
<div align="center">
<sub>🧬 Auto-generated by <b>Resurrection Bot 🧬</b> &nbsp;·&nbsp; Last run: 2026-05-02T19:59:38 &nbsp;·&nbsp; <a href="LICENSE">MIT License</a></sub>
</div>
<!-- END:footer -->

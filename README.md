...
<table>
  ...
  <tr>
    ...
    <td align="center"><code>~56.0h</code></td>
  </tr>
</table>

<sub>🕐 Last updated: 2026-05-07T20:19:44</sub>
<!-- END:stats -->
...
<table>
  <tr>
    <td>
      <b><a href="https://github.com/BurntSushi/ripgrep/issues/86">invoke a pager to display results</a></b><br/>
      <sub>📦 <code>BurntSushi/ripgrep</code> &nbsp;&#183;&nbsp; 💥 Impact: <b>6/10</b> &nbsp;&#183;&nbsp; 🗓️ 2026-05-07</sub><br/><br/>
      <i>The feature is now feasible due to improved terminal libraries and pager handling in Rust, making it a central and.</i>
    </td>
  </tr>
</table><!-- END:last -->
...
|:----:|-------|------|:------:|----------------|
| 🥇 | [support searching across multiple lines](https://github.com/BurntSushi/ripgrep/issues/176) | `BurntSushi/ripgrep` | **6/10** | Ripgrep's improved search engine and Rust's regex library make this feature feasible now. |
| 🥈 | [maximum line length](https://github.com/BurntSushi/ripgrep/issues/129) | `BurntSushi/ripgrep` | **6/10** | Ripgrep's new line length option improves usability for large files. |
| 🥉 | [Add an option similar to -o, --only-matching](https://github.com/BurntSushi/ripgrep/issues/34) | `BurntSushi/ripgrep` | **6/10** | This feature is now feasible due to improvements in the regex crate and modern Rust ecosystem. |<!-- END:hall-of-fame -->
...
<!-- SECTION:footer -->
<div align="center">
<sub>🧬 Auto-generated by <b>Resurrection Bot 🧬</b> &nbsp;·&nbsp; Last run: 2026-05-07T20:19:44 &nbsp;·&nbsp; <a href="LICENSE">MIT License</a></sub>
</div>
<!-- END:footer -->
